...
namespace GarageGames.Torque.PlatformerFramework
{
    ...
    public class FSM
    {
        ...
        public void RegisterState<T>(IFSMObject obj, string stateName) where T : FSMState, new()
        {
            ...
            Assert.Fatal(FSMTable != null, "FSM Manager failed to create a state hash. What the F?");
